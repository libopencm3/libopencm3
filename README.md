...
You can reduce the footprint of the library by specifying a particular MCU series

    $ make TARGETS='stm32/f1 stm32/f4'

Supported targets in the TARGETS list:

 - stm32/f0 stm32/f1 stm32/f2 stm32/f3 stm32/f4 stm32/f7
