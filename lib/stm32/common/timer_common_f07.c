...
#define ADVANCED_TIMERS defined(TIM1_BASE)
...
void timer_reset(uint32_t timer_peripheral)
{
	...
	case TIM2:
		...
		break;
	case TIM3:
		rcc_periph_reset_pulse(RCC_TIM3);
		break;
...
#endif
	case TIM6:
		rcc_periph_reset_pulse(RCC_TIM6);
		break;
	case TIM7:
		rcc_periph_reset_pulse(RCC_TIM7);
		break;
#if defined(TIM8_BASE)
	case TIM8:
		rcc_periph_reset_pulse(RCC_TIM8);
		break;
#endif
