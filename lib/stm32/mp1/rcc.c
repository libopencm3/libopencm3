...
void rcc_set_spi45_clksel(uint8_t clksel)
{
	...
	reg &= ~(RCC_SPI45CKSELR_SPI45SRC_MASK << RCC_SPI45CKSELR_SPI45SRC_SHIFT);
	reg |= ((clksel & RCC_SPI45CKSELR_SPI45SRC_MASK) << RCC_SPI45CKSELR_SPI45SRC_SHIFT);
...
{
	uint32_t reg = RCC_I2C12CKSELR;
	reg &= ~(RCC_I2C12CKSELR_I2C12SRC_MASK << RCC_I2C12CKSELR_I2C12SRC_SHIFT);
	reg |= ((clksel & RCC_I2C12CKSELR_I2C12SRC_MASK) << RCC_I2C12CKSELR_I2C12SRC_SHIFT);
