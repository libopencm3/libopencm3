...
void rcc_osc_ready_int_clear(enum rcc_osc osc)
{
	...
	case RCC_PLL:
		...
		break;
	case RCC_PLLSAI1:
		RCC_CICR |= RCC_CICR_PLLSAI1RDYC;
		break;
	case RCC_PLLSAI2:
		RCC_CICR |= RCC_CICR_PLLSAI2RDYC;
		break;
	case RCC_HSE:
...
void rcc_osc_ready_int_enable(enum rcc_osc osc)
{
	...
	case RCC_PLL:
		...
		break;
	case RCC_PLLSAI1:
		RCC_CIER |= RCC_CIER_PLLSAI1RDYIE;
		break;
	case RCC_PLLSAI2:
		RCC_CIER |= RCC_CIER_PLLSAI2RDYIE;
		break;
	case RCC_HSE:
...
int rcc_osc_ready_int_flag(enum rcc_osc osc)
{
	...
	case RCC_PLL:
		...
		break;
	case RCC_PLLSAI1:
		return ((RCC_CIFR & RCC_CIFR_PLLSAI1RDYF) != 0);
		break;
	case RCC_PLLSAI2:
		return ((RCC_CIFR & RCC_CIFR_PLLSAI2RDYF) != 0);
		break;
	case RCC_HSE:
...
bool rcc_is_osc_ready(enum rcc_osc osc)
{
	...
	case RCC_PLLSAI1:
		return RCC_CR & RCC_CR_PLLSAI1RDY;
	case RCC_PLLSAI2:
		return RCC_CR & RCC_CR_PLLSAI2RDY;
	case RCC_HSE:
