...
uint32_t ccs_get_extclk_frequency(void);
uint32_t ccs_get_frclk_frequency(void);
uint32_t ccs_get_sclk_frequency(void);
uint32_t ccs_get_pllclk_frequency(void);
uint32_t ccs_get_hclk_frequency(void);
uint32_t ccs_get_aclk_frequency(void);
uint32_t ccs_get_pclk_frequency(void);

uint32_t ccs_get_adc_clk_freq(uint32_t adc);
uint32_t ccs_get_i2c_clk_freq(uint32_t i2c);
uint32_t ccs_get_usart_clk_freq(uint32_t usart);
uint32_t ccs_get_can_clk_freq(uint32_t can);
uint32_t ccs_get_gptimer_clk_freq(uint32_t gptimer);
...
uint32_t ccs_get_rtc_clk_freq(uint32_t rtc);
uint32_t ccs_get_crc_clk_freq(uint32_t crc);
uint32_t ccs_get_systick_clk_freq(uint32_t systick);
