...
#define RCC_8MHZ_HSI_8MHZ_PLL			RCC_PLLCFGR_BITS(0, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_12MHZ_PLL			RCC_PLLCFGR_BITS(1, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_16MHZ_PLL			RCC_PLLCFGR_BITS(2, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_20MHZ_PLL			RCC_PLLCFGR_BITS(3, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_24MHZ_PLL			RCC_PLLCFGR_BITS(4, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_28MHZ_PLL			RCC_PLLCFGR_BITS(5, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_32MHZ_PLL			RCC_PLLCFGR_BITS(6, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_36MHZ_PLL			RCC_PLLCFGR_BITS(7, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_40MHZ_PLL			RCC_PLLCFGR_BITS(8, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_44MHZ_PLL			RCC_PLLCFGR_BITS(9, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
#define RCC_8MHZ_HSI_48MHZ_PLL			RCC_PLLCFGR_BITS(10, RCC_CFGR_PLLSRC_HSI_DIV_2, 0)
