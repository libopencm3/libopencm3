...
#define PWR_PORT_A		(POWER_CONTROL_BASE + 0x20)
#define PWR_PORT_B		(POWER_CONTROL_BASE + 0x28)
#define PWR_PORT_C		(POWER_CONTROL_BASE + 0x30)
#define PWR_PORT_D		(POWER_CONTROL_BASE + 0x38)
#define PWR_PORT_E		(POWER_CONTROL_BASE + 0x40)
#define PWR_PORT_F		(POWER_CONTROL_BASE + 0x48)
#define PWR_PORT_G		(POWER_CONTROL_BASE + 0x50)
#define PWR_PORT_H		(POWER_CONTROL_BASE + 0x58)
