...
#define REF_CFGR3			MMIO32(SYSCFG_BASE + 0x20)
...
#define REF_CFGR3_EN_VREFINT		(1 << 0)

#define REF_CFGR3_SEL_VREF_OUT_SHIFT	4
#define REF_CFGR3_SEL_VREF_OUT	(3 << REF_CFGR3_EN_VREFINT_SHIFT)
#define REF_CFGR3_SEL_VREF_OUT_PB0	(1 << REF_CFGR3_EN_VREFINT_SHIFT)
#define REF_CFGR3_SEL_VREF_OUT_PB1	(2 << REF_CFGR3_EN_VREFINT_SHIFT)

#define REF_CFGR3_ENBUF_VREFINT_ADC	(1 << 8)
#define REF_CFGR3_ENBUF_SENSOR_ADC	(1 << 9)
#define REF_CFGR3_ENBUF_VREFINT_COMP	(1 << 12)
#define REF_CFGR3_ENREF_HSI48	(1 << 13)

#define REF_CFGR3_REF_HSI48_RDYF	(1 << 26)
#define REF_CFGR3_SENSOR_ADC_RDYF	(1 << 27)
#define REF_CFGR3_VREFINT_ADC_RDYF	(1 << 28)
#define REF_CFGR3_VREFINT_COMP_RDYF	(1 << 29)
#define REF_CFGR3_VREFINT_RDYF	(1 << 30)
#define REF_CFGR3_REF_LOCK		(1 << 31)
