 ...
 *
 * @brief <b>Defined Constants and Types for the STM32L5xx Reset and Clock
 * Control</b>
 *
 * @version 1.0.0
 *
...
#define RCC_DLYCFGR				MMIO32(RCC_BASE + 0xA4)
#define RCC_SECCFGR				MMIO32(RCC_BASE + 0xB8)
#define RCC_SECSR				MMIO32(RCC_BASE + 0xBC)
#define RCC_AHB1SECSR			MMIO32(RCC_BASE + 0xE8)
#define RCC_AHB2SECSR			MMIO32(RCC_BASE + 0xEC)
#define RCC_AHB3SECSR			MMIO32(RCC_BASE + 0xF0)
#define RCC_APB1SECSR1			MMIO32(RCC_BASE + 0xF8)
#define RCC_APB1SECSR2			MMIO32(RCC_BASE + 0xFC)
#define RCC_APB2SECSR			MMIO32(RCC_BASE + 0x100)

/* Secure state value */
#define RCC_SEC_SECURE				1
#define RCC_SEC_NONSECURE			0

/* --- RCC_CR values ------------------------------------------------------- */

#define RCC_CR_PRIV					(1 << 31)
...
/* --- RCC_CCIPR1 - Peripherals independent clock config register 1 -------- */

#define RCC_CCIPR1_ADCSEL_NONE			0
#define RCC_CCIPR1_ADCSEL_PLLSAI1R		1
#define RCC_CCIPR1_ADCSEL_SYS			3
#define RCC_CCIPR1_ADCSEL_MASK			0x3
#define RCC_CCIPR1_ADCSEL_SHIFT			28

#define RCC_CCIPR1_CLK48SEL_HSI48		0
#define RCC_CCIPR1_CLK48SEL_PLLSAI1Q	1
#define RCC_CCIPR1_CLK48SEL_PLL			2
#define RCC_CCIPR1_CLK48SEL_MSI			3
#define RCC_CCIPR1_CLK48SEL_MASK		0x3
#define RCC_CCIPR1_CLK48SEL_SHIFT		26

#define RCC_CCIPR1_FDCANSEL_HSE			0
#define RCC_CCIPR1_FDCANSEL_PLL			1
#define RCC_CCIPR1_FDCANSEL_PLLSAI1P	2
#define RCC_CCIPR1_FDCANSEL_MASK		0x3
#define RCC_CCIPR1_FDCANSEL_SHIFT		24

#define RCC_CCIPR1_LPTIMxSEL_APB		0
#define RCC_CCIPR1_LPTIMxSEL_LSI		1
#define RCC_CCIPR1_LPTIMxSEL_HSI16		2
#define RCC_CCIPR1_LPTIMxSEL_LSE		3
#define RCC_CCIPR1_LPTIMxSEL_MASK		0x3
#define RCC_CCIPR1_LPTIM3SEL_SHIFT		22
#define RCC_CCIPR1_LPTIM2SEL_SHIFT		20
#define RCC_CCIPR1_LPTIM1SEL_SHIFT		18

#define RCC_CCIPR1_I2CxSEL_APB			0
#define RCC_CCIPR1_I2CxSEL_SYS			1
#define RCC_CCIPR1_I2CxSEL_HSI16		2
#define RCC_CCIPR1_I2CxSEL_MASK			0x3
#define RCC_CCIPR1_I2C3SEL_SHIFT		16
#define RCC_CCIPR1_I2C2SEL_SHIFT		14
#define RCC_CCIPR1_I2C1SEL_SHIFT		12

#define RCC_CCIPR1_LPUART1SEL_APB		0
#define RCC_CCIPR1_LPUART1SEL_SYS		1
#define RCC_CCIPR1_LPUART1SEL_HSI16		2
#define RCC_CCIPR1_LPUART1SEL_LSE		3
#define RCC_CCIPR1_LPUART1SEL_MASK		0x3
#define RCC_CCIPR1_LPUART1SEL_SHIFT		10

#define RCC_CCIPR1_USARTxSEL_APB		0
#define RCC_CCIPR1_USARTxSEL_SYS		1
#define RCC_CCIPR1_USARTxSEL_HSI16		2
#define RCC_CCIPR1_USARTxSEL_LSE		3
#define RCC_CCIPR1_USARTxSEL_MASK		0x3
#define RCC_CCIPR1_UARTxSEL_APB			RCC_CCIPR1_USARTxSEL_APB
#define RCC_CCIPR1_UARTxSEL_SYS			RCC_CCIPR1_USARTxSEL_SYS
#define RCC_CCIPR1_UARTxSEL_HSI16		RCC_CCIPR1_USARTxSEL_HSI16
#define RCC_CCIPR1_UARTxSEL_LSE			RCC_CCIPR1_USARTxSEL_LSE
#define RCC_CCIPR1_UARTxSEL_MASK		RCC_CCIPR1_USARTxSEL_MASK
...
#define RCC_CCIPR1_USART1SEL_APB		0
#define RCC_CCIPR1_USART1SEL_SYS		1
#define RCC_CCIPR1_USART1SEL_HSI16		2
#define RCC_CCIPR1_USART1SEL_LSE		3
#define RCC_CCIPR1_USART1SEL_SHIFT		0
...
/* --- RCC_CCIPR2 - Peripherals independent clock config register 2 -------- */

#define RCC_CCIPR2_OSPISEL_SYS			0
#define RCC_CCIPR2_OSPISEL_MSI			1
#define RCC_CCIPR2_OSPISEL_PLL48M1		2
#define RCC_CCIPR2_OSPISEL_MASK			0x3
#define RCC_CCIPR2_OSPISEL_SHIFT		20

#define RCC_CCIPR2_SDMMCSEL_48			0
#define RCC_CCIPR2_SDMMCSEL_PLLSAI3P	1
#define RCC_CCIPR2_SDMMCSEL_MASK		0x3
#define RCC_CCIPR2_SDMMCSEL_SHIFT		20

#define RCC_CCIPR2_SAIxSEL_PLLSAI1P		0
#define RCC_CCIPR2_SAIxSEL_PLLSAI2P		1
#define RCC_CCIPR2_SAIxSEL_PLLSAI3P		2
#define RCC_CCIPR2_SAIxSEL_EXT			3
#define RCC_CCIPR2_SAIxSEL_HSI			4
#define RCC_CCIPR2_SAIxSEL_MASK			0x7
#define RCC_CCIPR2_SAI2SEL_SHIFT		8
#define RCC_CCIPR2_SAI1SEL_SHIFT		5

#define RCC_CCIPR2_ADFSDMSEL_SAI1		0
#define RCC_CCIPR2_ADFSDMSEL_HSI		1
#define RCC_CCIPR2_ADFSDMSEL_MSI		2
#define RCC_CCIPR2_ADFSDMSEL_MASK		0x3
#define RCC_CCIPR2_ADFSDMSEL_SHIFT		3

#define RCC_CCIPR2_DFSDMSEL_APB			0
#define RCC_CCIPR2_DFSDMSEL_SYS			1
#define RCC_CCIPR2_DFSDMSEL_MASK		0x1
#define RCC_CCIPR2_DFSDMSEL_SHIFT		2

#define RCC_CCIPR2_I2C4SEL_APB			0
#define RCC_CCIPR2_I2C4SEL_SYS			1
#define RCC_CCIPR2_I2C4SEL_HSI16		2
#define RCC_CCIPR2_I2C4SEL_MASK			0x3
#define RCC_CCIPR2_I2C4SEL_SHIFT		0

/* --- RCC_DLYCFGR Delay configuration register  --------------------------- */

#define RCC_DLYCFGR_OCTOSPI_DLY_1		0
#define RCC_DLYCFGR_OCTOSPI_DLY_2		1
#define RCC_DLYCFGR_OCTOSPI_DLY_3		2
#define RCC_DLYCFGR_OCTOSPI_DLY_4		3
#define RCC_DLYCFGR_OCTOSPI_DLY_5		4
#define RCC_DLYCFGR_OCTOSPI_DLY_6		5
#define RCC_DLYCFGR_OCTOSPI_DLY_7		6
#define RCC_DLYCFGR_OCTOSPI_DLY_8		7
#define RCC_DLYCFGR_OCTOSPI_DLY_9		8
#define RCC_DLYCFGR_OCTOSPI_DLY_10		9
#define RCC_DLYCFGR_OCTOSPI_DLY_11		10
#define RCC_DLYCFGR_OCTOSPI_DLY_12		11
#define RCC_DLYCFGR_OCTOSPI_DLY_13		12
#define RCC_DLYCFGR_OCTOSPI_DLY_14		13
#define RCC_DLYCFGR_OCTOSPI_DLY_15		14
#define RCC_DLYCFGR_OCTOSPI_DLY_16		15
#define RCC_DLYCFGR_OCTOSPI_DLY_MASK	0xf
#define RCC_DLYCFGR_OCTOSPI_DLY_SHIFT	0

/* --- RCC_SECCFGR Secure configuration register --------------------------- */
#define RCC_SECCFGR_RMVF				( 1 << 12 )
#define RCC_SECCFGR_HSI48				( 1 << 11 ) 
#define RCC_SECCFGR_CLK48M				( 1 << 10 )
#define RCC_SECCFGR_PLLSAI2				( 1 << 9 )
#define RCC_SECCFGR_PLLSAI1				( 1 << 8 )
#define RCC_SECCFGR_PLL					( 1 << 7 )
#define RCC_SECCFGR_PRESC				( 1 << 6 )
#define RCC_SECCFGR_SYSCLK				( 1 << 5 )
#define RCC_SECCFGR_LSE					( 1 << 4 )
#define RCC_SECCFGR_LSI					( 1 << 3 )
#define RCC_SECCFGR_MSI					( 1 << 2 )
#define RCC_SECCFGR_HSE					( 1 << 1 )
#define RCC_SECCFGR_HSI					( 1 << 0 )


/* --- RCC_SECSR Secure status register ------------------------------------ */
#define RCC_SECSR_RMVF					( 1 << 12 )
#define RCC_SECSR_HSI48					( 1 << 11 )
#define RCC_SECSR_CLK48M				( 1 << 10 )
#define RCC_SECSR_PLLSAI2				( 1 << 9 )
#define RCC_SECSR_PLLSAI1				( 1 << 8 )
#define RCC_SECSR_PLL					( 1 << 7 )
#define RCC_SECSR_PRESC					( 1 << 6 )
#define RCC_SECSR_SYSCLK				( 1 << 5 )
#define RCC_SECSR_LSE					( 1 << 4 )
#define RCC_SECSR_LSI					( 1 << 3 )
#define RCC_SECSR_MSI					( 1 << 2 )
#define RCC_SECSR_HSE					( 1 << 1 )
#define RCC_SECSR_HSI					( 1 << 0 )
...
enum rcc_periph_clken {
	...
	/* AHB1 peripherals */
	RCC_GTZ = _REG_BIT(RCC_AHB1ENR_OFFSET, 22),
	RCC_TSC = _REG_BIT(RCC_AHB1ENR_OFFSET, 16),
	RCC_CRC = _REG_BIT(RCC_AHB1ENR_OFFSET, 12),
	RCC_FLASH = _REG_BIT(RCC_AHB1ENR_OFFSET, 8),
	RCC_DMAMUX = _REG_BIT(RCC_AHB1ENR_OFFSET, 2),
	RCC_DMA2 = _REG_BIT(RCC_AHB1ENR_OFFSET, 1),
	RCC_DMA1 = _REG_BIT(RCC_AHB1ENR_OFFSET, 0),

	/* AHB2 peripherals */
	RCC_SDMMC1 = _REG_BIT(RCC_AHB2ENR_OFFSET, 22),
	RCC_OTFDEC1 = _REG_BIT(RCC_AHB2ENR_OFFSET, 21),
	RCC_PKA = _REG_BIT(RCC_AHB2ENR_OFFSET, 19),
	RCC_RNG = _REG_BIT(RCC_AHB2ENR_OFFSET, 18),
	RCC_HASH = _REG_BIT(RCC_AHB2ENR_OFFSET, 17),
	...
	/* AHB3 peripherals */
	RCC_OSPI = _REG_BIT(RCC_AHB3ENR_OFFSET, 8),
	...
	/* apb1-2 */
	RCC_UCPD1 = _REG_BIT(RCC_APB1ENR2_OFFSET, 23),
	RCC_USB = _REG_BIT(RCC_APB1ENR2_OFFSET, 21),
	RCC_FDCAN1 = _REG_BIT(RCC_APB1ENR2_OFFSET, 9),
	...
	SCC_ICACHE = _REG_BIT(RCC_AHB1SMENR_OFFSET, 23),
	SCC_GTZ = _REG_BIT(RCC_AHB1SMENR_OFFSET, 22),
	...
	SCC_SDMMC1 = _REG_BIT(RCC_AHB2SMENR_OFFSET, 22),
	SCC_OTFDEC1 = _REG_BIT(RCC_AHB2SMENR_OFFSET, 21),
	SCC_PKA = _REG_BIT(RCC_AHB2SMENR_OFFSET, 19),
	SCC_RNG = _REG_BIT(RCC_AHB2SMENR_OFFSET, 18),
	SCC_HASH = _REG_BIT(RCC_AHB2SMENR_OFFSET, 17),
	...
	SCC_OSPI = _REG_BIT(RCC_AHB3SMENR_OFFSET, 8),
	...
	SCC_CRS = _REG_BIT(RCC_APB1ENR1_OFFSET, 24),
	...
	SCC_RTCAPB = _REG_BIT(RCC_APB1ENR1_OFFSET, 10),
	...
	/* apb1-2 */
	SCC_UCPD1 = _REG_BIT(RCC_APB1ENR2_OFFSET, 23),
	SCC_USB = _REG_BIT(RCC_APB1ENR2_OFFSET, 21),
	SCC_FDCAN1 = _REG_BIT(RCC_APB1ENR2_OFFSET, 9),
	SCC_LPTIM3 = _REG_BIT(RCC_APB1ENR2_OFFSET, 6),
	SCC_LPTIM2 = _REG_BIT(RCC_APB1ENR2_OFFSET, 5),
	SCC_I2C4 = _REG_BIT(RCC_APB1ENR2_OFFSET, 1),
...
enum rcc_periph_rst {
	...
	/* AHB2 peripherals */
	RST_SDMMC1 = _REG_BIT(RCC_AHB2RSTR_OFFSET, 22),
	RST_OTDFEC1 = _REG_BIT(RCC_AHB2RSTR_OFFSET, 21),
	RST_PKA = _REG_BIT(RCC_AHB2RSTR_OFFSET, 19),
	RST_RNG = _REG_BIT(RCC_AHB2RSTR_OFFSET, 18),
	RST_HASH = _REG_BIT(RCC_AHB2RSTR_OFFSET, 17),
	...
	/* AHB3 peripherals */
	RST_OSPI = _REG_BIT(RCC_AHB3RSTR_OFFSET, 8),
	...
	/* apb1-2 */
	RST_UCPD1 = _REG_BIT(RCC_APB1RSTR2_OFFSET, 23),
	RST_USB = _REG_BIT(RCC_APB1RSTR2_OFFSET, 21),
	RST_FDCAN1 = _REG_BIT(RCC_APB1RSTR2_OFFSET, 9),
