...
#define RCC_AHB2RSTR_OFTDEC1RST			(1 << 21)
#define RCC_AHB2RSTR_PKARST			(1 << 19)
...
@{*/
#define RCC_AHB3RSTR_OSPIRST			(1 << 8)
...
@{*/
#define RCC_APB1RSTR2_UCPD1RST			(1 << 23)
#define RCC_APB1RSTR2_USBFSRST			(1 << 21)
...
@{*/
#define RCC_AHB1ENR_GTZCEN			(1 << 22)
...
#define RCC_AHB2ENR_OFTDEC1EN			(1 << 21)
#define RCC_AHB2ENR_PKAEN			(1 << 19)
...
@{*/
#define RCC_APB1ENR2_UCPD1EN			(1 << 23)
#define RCC_APB1ENR2_USBFSEN			(1 << 21)
#define RCC_APB1ENR2_FDCAN1EN			(1 << 9)
...
#define RCC_AHB1SMENR_ICACHESMEN		(1 << 23)
#define RCC_AHB1SMENR_GTZCSMEN			(1 << 22)
...
#define RCC_AHB2SMENR_OFTDEC1SMEN		(1 << 21)
#define RCC_AHB2SMENR_PKASMEN			(1 << 19)
...
#define RCC_AHB3SMENR_OSPISMEN			(1 << 8)
...
#define RCC_APB1SMENR2_UCPD1SMEN		(1 << 23)
#define RCC_APB1SMENR2_USBFSSMEN		(1 << 21)
#define RCC_APB1SMENR2_FDCAN1SMEN		(1 << 9)
...
enum rcc_periph_clken {
	...
	/* AHB1 peripherals */
	RCC_GTZC = _REG_BIT(RCC_AHB1ENR_OFFSET, 22),
	...
	RCC_OFTDEC1 = _REG_BIT(RCC_AHB2ENR_OFFSET, 21),
	...
	RCC_USBFS = _REG_BIT(RCC_APB1ENR2_OFFSET, 21),
	...
	SCC_GTZC = _REG_BIT(RCC_AHB1SMENR_OFFSET, 22),
	...
	SCC_OFTDEC1 = _REG_BIT(RCC_AHB2SMENR_OFFSET, 21),
	...
	SCC_OPAMP = _REG_BIT(RCC_APB1SMENR1_OFFSET, 30),
	SCC_DAC1 = _REG_BIT(RCC_APB1SMENR1_OFFSET, 29),
	SCC_PWR = _REG_BIT(RCC_APB1SMENR1_OFFSET, 28),
	SCC_CRS = _REG_BIT(RCC_APB1SMENR1_OFFSET, 24),
	SCC_I2C3 = _REG_BIT(RCC_APB1SMENR1_OFFSET, 23),
	...
	/* apb1-2 */
	SCC_UCPD1 = _REG_BIT(RCC_APB1SMENR2_OFFSET, 23),
	SCC_USBFS = _REG_BIT(RCC_APB1SMENR2_OFFSET, 21),
	SCC_FDCAN1 = _REG_BIT(RCC_APB1SMENR2_OFFSET, 9),
	SCC_LPTIM3 = _REG_BIT(RCC_APB1SMENR2_OFFSET, 6),
	SCC_LPTIM2 = _REG_BIT(RCC_APB1SMENR2_OFFSET, 5),
	SCC_I2C4 = _REG_BIT(RCC_APB1SMENR2_OFFSET, 1),
	SCC_LPUART1 = _REG_BIT(RCC_APB1SMENR2_OFFSET, 0),

	/* APB2 peripherals in sleep mode */
	SCC_DFSDM = _REG_BIT(RCC_APB2SMENR_OFFSET, 24),
	SCC_SAI2 = _REG_BIT(RCC_APB2SMENR_OFFSET, 22),
...
enum rcc_periph_rst {
	...
	RST_OFTDEC1 = _REG_BIT(RCC_AHB2RSTR_OFFSET, 21),
	...
	RST_USBFS = _REG_BIT(RCC_APB1RSTR2_OFFSET, 21),
	RST_FDCAN = _REG_BIT(RCC_APB1RSTR2_OFFSET, 9),
