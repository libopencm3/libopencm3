...
/****************************************************************************/
/** @defgroup adcf4_reg_base ADC register base addresses
...
/****************************************************************************/
/** @defgroup adcf4_channel ADC Channel Numbers
@ingroup STM32F4xx_adc_defines
...
/* RES[1:0]: Resolution */
/****************************************************************************/
/** @defgroup adcf4_cr1_res ADC Resolution.
@ingroup STM32F4xx_adc_defines
...
/****************************************************************************/
/** @defgroup adcf4_cr1_discnum ADC Number of channels in discontinuous mode.
@ingroup STM32F4xx_adc_defines
 ...
 */
/****************************************************************************/
/** @defgroup adcf4_watchdog_channel ADC watchdog channel
@ingroup STM32F4xx_adc_defines
...
/****************************************************************************/
/** @defgroup adcf4_trigger_polarity_regular ADC Trigger Polarity
@ingroup STM32F4xx_adc_defines
...
/****************************************************************************/
/** @defgroup adcf4_trigger_regular ADC Trigger Identifier for Regular group
@ingroup STM32F4xx_adc_defines
...
/****************************************************************************/
/** @defgroup adcf4_trigger_polarity_injected ADC Trigger Polarity
@ingroup STM32F4xx_adc_defines
...
/****************************************************************************/
/** @defgroup adcf4_trigger_injected ADC Trigger Identifier for Injected group
@ingroup STM32F4xx_adc_defines
...
/****************************************************************************/
/** @defgroup adcf4_ccr_adcpre ADC Prescale
@ingroup STM32F4xx_adc_defines
...
/* DMA: Direct memory access mdoe for multi ADC mode. */
...
#define ADC_CCR_MULTI_DUAL_RESERVED							(0x08 << 0)
...
#define ADC_CCR_MULTI_TRIPLE_RESERVED							(0x18 << 0)
...
void adc_set_clk(u32 prescaler);
