...
#define FMC_SDCR_RPIPE_NONE						(0 << FMC_SDCR_RPIPE_SHIFT)   /* No Delay */
#define FMC_SDCR_RPIPE_1CLK						(1 << FMC_SDCR_RPIPE_SHIFT)   /* one clock */
#define FMC_SDCR_RPIPE_2CLK						(2 << FMC_SDCR_RPIPE_SHIFT)   /* two clocks */
