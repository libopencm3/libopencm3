 ...
 */
#define QUADSPI_GET(reg, field, x) \
    (((x) >> QUADSPI_ ## reg ## _ ## field ##_SHIFT) & QUADSPI_ ## reg ##_ ## field ##_MASK)

#define QUADSPI_SET(reg, field, x) \
    (((x) & QUADSPI_ ## reg ##_## field ##_MASK) << QUADSPI_## reg ##_## field ##_SHIFT)
