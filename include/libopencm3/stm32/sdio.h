...
#define SDIO_CMD_WAITRESP_MASK		(0x3 << SDIO_CMD_WAITRESP_SHIFT)
...
#define SDIO_DLEN_DATALENGTH_MASK	(0x1FFFFFF << SDIO_DLEN_DATALENGTH_SHIFT)
...
#define SDIO_FIFOCNT_FIFOCOUNT_MASK	(0xFFFFFF << SDIO_FIFOCNT_FIFOCOUNT_SHIFT)
