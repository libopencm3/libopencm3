...
#define GFXMMU_BUFFER_BASE		(0x30000000U)
#define GFXMMU_BUFFER0_BASE		(GFXMMU_BUFFER_BASE + 0x000000U)
#define GFXMMU_BUFFER1_BASE		(GFXMMU_BUFFER_BASE + 0x400000U)
#define GFXMMU_BUFFER2_BASE		(GFXMMU_BUFFER_BASE + 0x800000U)
#define GFXMMU_BUFFER3_BASE		(GFXMMU_BUFFER_BASE + 0xC00000U)
#define PERIPH_BASE			(0x40000000U)
#define FMC1_BANK_BASE			(0x60000000U)
#define OCTOSPI2_BANK_BASE		(0x70000000U)
#define FMC3_BANK_BASE			(0x80000000U)
#define OCTOSPI1_BANK_BASE		(0x90000000U)
#define QUADSPI_BANK_BASE		OCTOSPI1_BANK_BASE /* compat. with l4 */
#define FMC_OCTOSPI_BASE		(0xA0000000U)
#define FMC_QUADSPI_BASE		FMC_OCTOSPI_BASE /* compat. with l4 */
...
#define LTDC_BASE			LCD_TFT_BASE /* compat. with f4 */
...
#define GFXMMU_BASE			(PERIPH_BASE_AHB1 + 0xc000)
...
#define GPIO_PORT_I_BASE		(PERIPH_BASE_AHB2 + 0x2000)
/* Still AHB2, good job ST */
#define OTG_FS_BASE			(0x50000000U + 0x00000)
#define ADC1_BASE			(0x50000000U + 0x40000)
#define DCMI_BASE			(0x50000000U + 0x50000)
#define AES_BASE			(0x50000000U + 0x60000)
#define HASH_BASE			(0x50000000U + 0x60400)
#define RNG_BASE			(0x50000000U + 0x60800)
#define OCTOSPIIOM_BASE			(0x50000000U + 0x61c00)
#define SDMMC1_BASE			(0x50000000U + 0x62400)
