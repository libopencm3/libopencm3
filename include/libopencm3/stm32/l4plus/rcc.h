 ...
 *
 * @brief <b>Defined Constants and Types for the STM32L4Rxx/STM32L4Sxx Reset and Clock
 * Control</b>
 *
...
#define RCC_PLLCFGR_PLLP_DIV2		2
#define RCC_PLLCFGR_PLLP_DIV3		3
#define RCC_PLLCFGR_PLLP_DIV4		4
#define RCC_PLLCFGR_PLLP_DIV5		5
#define RCC_PLLCFGR_PLLP_DIV6		6
#define RCC_PLLCFGR_PLLP_DIV7		7
#define RCC_PLLCFGR_PLLP_DIV8		8
#define RCC_PLLCFGR_PLLP_DIV9		9
#define RCC_PLLCFGR_PLLP_DIV10		10
#define RCC_PLLCFGR_PLLP_DIV11		11
#define RCC_PLLCFGR_PLLP_DIV12		12
#define RCC_PLLCFGR_PLLP_DIV13		13
#define RCC_PLLCFGR_PLLP_DIV14		14
#define RCC_PLLCFGR_PLLP_DIV15		15
#define RCC_PLLCFGR_PLLP_DIV16		16
#define RCC_PLLCFGR_PLLP_DIV17		17
#define RCC_PLLCFGR_PLLP_DIV18		18
#define RCC_PLLCFGR_PLLP_DIV19		19
#define RCC_PLLCFGR_PLLP_DIV20		20
#define RCC_PLLCFGR_PLLP_DIV21		21
#define RCC_PLLCFGR_PLLP_DIV22		22
#define RCC_PLLCFGR_PLLP_DIV23		23
#define RCC_PLLCFGR_PLLP_DIV24		24
#define RCC_PLLCFGR_PLLP_DIV25		25
#define RCC_PLLCFGR_PLLP_DIV26		26
#define RCC_PLLCFGR_PLLP_DIV27		27
#define RCC_PLLCFGR_PLLP_DIV28		28
#define RCC_PLLCFGR_PLLP_DIV29		29
#define RCC_PLLCFGR_PLLP_DIV30		30
#define RCC_PLLCFGR_PLLP_DIV31		31
#define RCC_PLLCFGR_PLLPEN		(1 << 16)

/** @defgroup rcc_pllcfgr_plln RCC_PLLCFGR PLLN values
@ingroup rcc_defines
 * Allowed values 8 <= n <= 127
@{*/
...
/* --- RCC_PLLSAI1CFGR ----------------------------------------------------- */
/* Same as RCC_PLLCFGR, except there is no PLLSRC */
/* --- RCC_PLLSAI2CFGR ----------------------------------------------------- */
/* Same as RCC_PLLCFGR, except there is no PLLSRC */
...
@{*/
#define RCC_AHB1RSTR_GFXMMU			(1 << 18)
...
#define RCC_AHB1RSTR_DMAMUXRST			(1 << 2)
...
#define RCC_AHB2RSTR_OSPIRST			(1 << 20)
...
#define RCC_AHB3RSTR_OSPI1RST			(1 << 8)
...
#define RCC_AHB3ENR_OSPI1EN			(1 << 8)
...
#define RCC_AHB1SMENR_DMAMUXSMEN		(1 << 2)
...
#define RCC_AHB3SMENR_OSPI2SMEN			(1 << 9)
#define RCC_AHB3SMENR_OSPI1SMEN			(1 << 8)
...
#define RCC_APB1SMENR1_CRSSMEN			(1 << 25)
...
#define RCC_CCIPR2_OSPISEL_PLL48M1CLK	2
#define RCC_CCIPR2_OSPISEL_MASK		0x3
#define RCC_CCIPR2_OSPISEL_SHIFT	20

#define RCC_CCIPR2_PLLSAI2DIVR_DIV2	0
#define RCC_CCIPR2_PLLSAI2DIVR_DIV4	1
#define RCC_CCIPR2_PLLSAI2DIVR_DIV8	2
#define RCC_CCIPR2_PLLSAI2DIVR_DIV16	3
#define RCC_CCIPR2_PLLSAI2DIVR_MASK	0x3
#define RCC_CCIPR2_PLLSAI2DIVR_SHIFT	16

#define RCC_CCIPR2_SDMMCSEL		(1 << 14)
#define RCC_CCIPR2_DSISEL		(1 << 12)

#define RCC_CCIPR2_SAI2SEL_PLLSAI1CLK	0
#define RCC_CCIPR2_SAI2SEL_PLLSAI2CLK	1
#define RCC_CCIPR2_SAI2SEL_PLLSAI3CLK	2
#define RCC_CCIPR2_SAI2SEL_SAI2EXTCLK	3
#define RCC_CCIPR2_SAI2SEL_HSI		4
#define RCC_CCIPR2_SAI2SEL_MASK		0x7
#define RCC_CCIPR2_SAI2SEL_SHIFT	8

#define RCC_CCIPR2_SAI1SEL_PLLSAI1CLK	0
#define RCC_CCIPR2_SAI1SEL_PLLSAI2CLK	1
#define RCC_CCIPR2_SAI1SEL_PLLSAI3CLK	2
#define RCC_CCIPR2_SAI1SEL_SAI2EXTCLK	3
#define RCC_CCIPR2_SAI1SEL_HSI		4
#define RCC_CCIPR2_SAI1SEL_MASK		0x7
#define RCC_CCIPR2_SAI1SEL_SHIFT	5

#define RCC_CCIPR2_ADFSDMSEL_SAI1CLK	0
...
#define RCC_CCIPR2_I2C4SEL_PCLK		0
...
enum rcc_periph_clken {
	...
	/* AHB1 peripherals */
	RCC_GFXMMU = _REG_BIT(RCC_AHB1ENR_OFFSET, 18),
	RCC_DMA2D = _REG_BIT(RCC_AHB1ENR_OFFSET, 17),
	...
	/* AHB3 peripherals */
	RCC_OSPI2 = _REG_BIT(RCC_AHB3ENR_OFFSET, 9),
	RCC_OSPI1 = _REG_BIT(RCC_AHB3ENR_OFFSET, 8),
	...
	/* APB2 peripherals */
	RCC_DSI = _REG_BIT(RCC_APB2ENR_OFFSET, 27),
	RCC_LTDC = _REG_BIT(RCC_APB2ENR_OFFSET, 26),
	...
	SCC_GFXMMU = _REG_BIT(RCC_AHB1SMENR_OFFSET, 18),
	SCC_DMA2D = _REG_BIT(RCC_AHB1SMENR_OFFSET, 17),
	...
	SCC_OSPIM = _REG_BIT(RCC_AHB2SMENR_OFFSET, 20),
	...
	SCC_DCMI = _REG_BIT(RCC_AHB2SMENR_OFFSET, 14),
	SCC_ADC = _REG_BIT(RCC_AHB2SMENR_OFFSET, 13),
	SCC_ADC1 = _REG_BIT(RCC_AHB2SMENR_OFFSET, 13), /* Compatibility */
	SCC_USB = _REG_BIT(RCC_AHB2SMENR_OFFSET, 12), /* Called OTGFS in the manual */
	SCC_SRAM3 = _REG_BIT(RCC_AHB2SMENR_OFFSET, 10),
	SCC_SRAM2 = _REG_BIT(RCC_AHB2SMENR_OFFSET, 9),
	SCC_GPIOI = _REG_BIT(RCC_AHB2SMENR_OFFSET, 8),
	...
	SCC_OSPI2 = _REG_BIT(RCC_AHB3SMENR_OFFSET, 9),
	SCC_OSPI1 = _REG_BIT(RCC_AHB3SMENR_OFFSET, 8),
	...
	SCC_DSI = _REG_BIT(RCC_APB2ENR_OFFSET, 27),
	SCC_LTDC = _REG_BIT(RCC_APB2ENR_OFFSET, 26),
...
enum rcc_periph_rst {
	/* AHB1 peripherals */
	RST_GFXMMU = _REG_BIT(RCC_AHB1RSTR_OFFSET, 18),
	RST_DMA2D = _REG_BIT(RCC_AHB1RSTR_OFFSET, 17),
	...
	/* AHB3 peripherals */
	RST_OSPI2 = _REG_BIT(RCC_AHB3RSTR_OFFSET, 9),
	RST_OSPI1 = _REG_BIT(RCC_AHB3RSTR_OFFSET, 8),
	...
	RST_I2C4 = _REG_BIT(RCC_APB1RSTR1_OFFSET, 1),
	RST_LPUART1 = _REG_BIT(RCC_APB1RSTR2_OFFSET, 0),

	/* APB2 peripherals */
	RST_DSI = _REG_BIT(RCC_APB2RSTR_OFFSET, 27),
	RST_LTDC = _REG_BIT(RCC_APB2RSTR_OFFSET, 26),
