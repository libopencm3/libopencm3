 ...
 * @author @htmlonly &copy; @endhtmlonly 2020
 * Sam Kirkham <sam.kirkham@codethink.co.uk>
 * @author @htmlonly &copy; @endhtmlonly 2020
...
#define RCC_PLLCFGR_PLLP_MASK		0x1

#define RCC_PLLCFGR_PLLPEN		(1 << 16)

/** @defgroup rcc_pllcfgr_plln RCC_PLLCFGR PLLN values
 * Allowed values 8 <= n <= 127, VCO output between 96 and 344 MHz
 * @{*/
 ...
 * Allowed values 1 <= m <= 16, VCO input between 2.66 and 16 MHz
 * @{*/
...
enum rcc_periph_clken {
	...
	RCC_ADC3	= _REG_BIT(RCC_AHB2ENR_OFFSET, 14), /* Compatibility */
	RCC_ADC4	= _REG_BIT(RCC_AHB2ENR_OFFSET, 14), /* Compatibility */
	RCC_ADC5	= _REG_BIT(RCC_AHB2ENR_OFFSET, 14), /* Compatibility */
	RCC_ADC12	= _REG_BIT(RCC_AHB2ENR_OFFSET, 13),
	RCC_ADC1	= _REG_BIT(RCC_AHB2ENR_OFFSET, 13), /* Compatibility */
	RCC_ADC2	= _REG_BIT(RCC_AHB2ENR_OFFSET, 13), /* Compatibility */
	...
	SCC_ADC3	= _REG_BIT(RCC_AHB2SMENR_OFFSET, 14), /* Compatibility */
	SCC_ADC4	= _REG_BIT(RCC_AHB2SMENR_OFFSET, 14), /* Compatibility */
	SCC_ADC5	= _REG_BIT(RCC_AHB2SMENR_OFFSET, 14), /* Compatibility */
	SCC_ADC12	= _REG_BIT(RCC_AHB2SMENR_OFFSET, 13),
	SCC_ADC1	= _REG_BIT(RCC_AHB2SMENR_OFFSET, 13), /* Compatibility */
	SCC_ADC2	= _REG_BIT(RCC_AHB2SMENR_OFFSET, 13), /* Compatibility */
