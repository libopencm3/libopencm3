...
@brief <b>Defined Constants and Types for the STM32G4xx DBGMCU Component</b>
...
#define DBGMCU_APB1FZR1_I2C3_STOP	(1 << 30)
...
#define DBGMCU_APB2FZR_HRTIM_STOP	(1 << 26)
/** TIM20 counter stopped when core is halted */
#define DBGMCU_APB2FZR_TIM20_STOP	(1 << 20)
