...
#ifndef LIBOPENCM3_USART_COMMON_L0F0_H
#define LIBOPENCM3_USART_COMMON_L0F0_H
...
/** @cond */
#else
#warning "usart_common_l0f0.h should not be included directly, only via usart.h"
#endif
/** @endcond */
