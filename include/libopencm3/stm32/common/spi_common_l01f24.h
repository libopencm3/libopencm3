...
/** @endcond */
#ifndef LIBOPENCM3_SPI_COMMON_L01F24_H
#define LIBOPENCM3_SPI_COMMON_L01F24_H

/**@{*/

#include <libopencm3/stm32/common/spi_common_f1.h>
...
/** @cond */
#else
#warning "spi_common_l01f24.h should not be included explicitly, only via spi.h"
#endif
/** @endcond */
/**@}*/
