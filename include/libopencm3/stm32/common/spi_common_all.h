...
#define SPI4_CR1			SPI_CR1(SPI4_BASE)
#define SPI5_CR1			SPI_CR1(SPI5_BASE)
#define SPI6_CR1			SPI_CR1(SPI6_BASE)
...
#define SPI4_CR2			SPI_CR2(SPI4_BASE)
#define SPI5_CR2			SPI_CR2(SPI5_BASE)
#define SPI6_CR2			SPI_CR2(SPI6_BASE)
...
#define SPI5_SR				SPI_SR(SPI5_BASE)
#define SPI6_SR				SPI_SR(SPI6_BASE)
...
#define SPI5_DR				SPI_DR(SPI5_BASE)
#define SPI6_DR				SPI_DR(SPI6_BASE)
...
#define SPI4_CRCPR			SPI_CRCPR(SPI4_BASE)
#define SPI5_CRCPR			SPI_CRCPR(SPI5_BASE)
#define SPI6_CRCPR			SPI_CRCPR(SPI6_BASE)
...
#define SPI4_RXCRCR			SPI_RXCRCR(SPI4_BASE)
#define SPI5_RXCRCR			SPI_RXCRCR(SPI5_BASE)
#define SPI6_RXCRCR			SPI_RXCRCR(SPI6_BASE)
...
#define SPI4_TXCRCR			SPI_TXCRCR(SPI4_BASE)
#define SPI5_TXCRCR			SPI_TXCRCR(SPI5_BASE)
#define SPI6_TXCRCR			SPI_TXCRCR(SPI6_BASE)
...
#define SPI4_I2SCFGR			SPI_I2SCFGR(SPI4_BASE)
#define SPI5_I2SCFGR			SPI_I2SCFGR(SPI5_BASE)
#define SPI6_I2SCFGR			SPI_I2SCFGR(SPI6_BASE)
...
#define SPI4_I2SPR			SPI_I2SPR(SPI4_BASE)
#define SPI5_I2SPR			SPI_I2SPR(SPI5_BASE)
#define SPI6_I2SPR			SPI_I2SPR(SPI6_BASE)
