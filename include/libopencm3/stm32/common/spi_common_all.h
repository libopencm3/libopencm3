...
#define SPI_I2SCFGR_I2SCFG_SLAVE_TRANSMIT	(0x0 << SPI_I2SCFGR_I2SCFG_LSB)
#define SPI_I2SCFGR_I2SCFG_SLAVE_RECEIVE	(0x1 << SPI_I2SCFGR_I2SCFG_LSB)
#define SPI_I2SCFGR_I2SCFG_MASTER_TRANSMIT	(0x2 << SPI_I2SCFGR_I2SCFG_LSB)
#define SPI_I2SCFGR_I2SCFG_MASTER_RECEIVE	(0x3 << SPI_I2SCFGR_I2SCFG_LSB)
...
#define SPI_I2SCFGR_I2SSTD_I2S_PHILIPS		(0x0 << SPI_I2SCFGR_I2SSTD_LSB)
#define SPI_I2SCFGR_I2SSTD_MSB_JUSTIFIED	(0x1 << SPI_I2SCFGR_I2SSTD_LSB)
#define SPI_I2SCFGR_I2SSTD_LSB_JUSTIFIED	(0x2 << SPI_I2SCFGR_I2SSTD_LSB)
#define SPI_I2SCFGR_I2SSTD_PCM			(0x3 << SPI_I2SCFGR_I2SSTD_LSB)
...
#define SPI_I2SCFGR_DATLEN_16BIT		(0x0 << SPI_I2SCFGR_DATLEN_LSB)
#define SPI_I2SCFGR_DATLEN_24BIT		(0x1 << SPI_I2SCFGR_DATLEN_LSB)
#define SPI_I2SCFGR_DATLEN_32BIT		(0x2 << SPI_I2SCFGR_DATLEN_LSB)
