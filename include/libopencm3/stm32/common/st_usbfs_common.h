...
/*
 * Double-buffered endpoint buffer addresses
 * Ref. "Figure 220. Packet buffer areas with examples of buffer description
 * table locations" in RM0008
 */
...
#define USB_GET_EP_RX_0_ADDR(EP)         GET_REG(USB_EP_RX_0_ADDR(EP))
#define USB_GET_EP_RX_0_COUNT(EP)        GET_REG(USB_EP_RX_0_COUNT(EP))
#define USB_GET_EP_RX_1_ADDR(EP)         GET_REG(USB_EP_RX_1_ADDR(EP))
#define USB_GET_EP_RX_1_COUNT(EP)        GET_REG(USB_EP_RX_1_COUNT(EP))
#define USB_GET_EP_TX_0_ADDR(EP)         GET_REG(USB_EP_TX_0_ADDR(EP))
#define USB_GET_EP_TX_0_COUNT(EP)        GET_REG(USB_EP_TX_0_COUNT(EP))
#define USB_GET_EP_TX_1_ADDR(EP)         GET_REG(USB_EP_TX_1_ADDR(EP))
#define USB_GET_EP_TX_1_COUNT(EP)        GET_REG(USB_EP_TX_1_COUNT(EP))

#define USB_SET_EP_RX_0_ADDR(EP, ADDR)   SET_REG(USB_EP_RX_0_ADDR(EP), ADDR)
#define USB_SET_EP_RX_0_COUNT(EP, COUNT) SET_REG(USB_EP_RX_0_COUNT(EP), COUNT)
#define USB_SET_EP_RX_1_ADDR(EP, ADDR)   SET_REG(USB_EP_RX_1_ADDR(EP), ADDR)
#define USB_SET_EP_RX_1_COUNT(EP, COUNT) SET_REG(USB_EP_RX_1_COUNT(EP), COUNT)
#define USB_SET_EP_TX_0_ADDR(EP, ADDR)   SET_REG(USB_EP_TX_0_ADDR(EP), ADDR)
#define USB_SET_EP_TX_0_COUNT(EP, COUNT) SET_REG(USB_EP_TX_0_COUNT(EP), COUNT)
#define USB_SET_EP_TX_1_ADDR(EP, ADDR)   SET_REG(USB_EP_TX_1_ADDR(EP), ADDR)
#define USB_SET_EP_TX_1_COUNT(EP, COUNT) SET_REG(USB_EP_TX_1_COUNT(EP), COUNT)
