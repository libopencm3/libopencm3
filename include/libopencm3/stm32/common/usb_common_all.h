...
@brief <b>Defined Constants and Types for the STM32F1xx, STM32F0xx, STM32L0xx_defines USB Module</b>

@ingroup STM32F1xx_defines STM32F0xx_defines STM32L0xx_defines
...
The order of header inclusion is important. usb.h includes the device
specific memorymap.h header before including this header file.*/

/** @cond */
#if defined(LIBOPENCM3_USB_H)
/** @endcond */
...
/** @cond */
#else
#warning "usb_common_all.h should not be included directly, only via usb.h"
#endif
/** @endcond */
/**@}*/
