...
/*
 * Extracted from RM0376 rev 3, STM32L0x2 reference manual.
 * and from PM0062 rev2, L15xx and L16xx Flash/EEPROM programming
 */
...
#define FLASH_PECR_PARRALELBANK	(1 << 15)
...
/* Program/erase key register (FLASH_PKEYR) */
...
/** @cond */
#else
#warning "flash_common_l01.h should not be included directly,"
