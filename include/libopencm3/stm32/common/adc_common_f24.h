...
@brief <b>Defined Constants and Types for the STM32F4xx and STM32F2xx Analog to Digital
Converters</b>

@ingroup STM32F4xx and STM32F2xx defines

@version 1.0.0

@author @htmlonly &copy; @endhtmlonly 2024
Bence Farkas <benfarkas98@protonmail.com>
 ...
 *
 * Copyright (C) 2024 Bence Farkas <benfarkas98@protonmail.com>
...
/** @endcond */
#ifndef LIBOPENCM3_ADC_COMMON_F24_H
#define LIBOPENCM3_ADC_COMMON_F24_H
 ...
 *@{*/
#define ADC_CHANNEL_TEMP_F2X	16
