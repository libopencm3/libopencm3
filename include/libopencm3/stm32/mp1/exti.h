 ...
 *
 * @brief <b>Defined Constants and Types for the STM32MP1xx External Interrupts
 * </b>
 *
...
#define EXTI_TZENR1    MMIO32(EXTI_BASE + 0x014)
#define EXTI_TZENR2    MMIO32(EXTI_BASE + 0x034)
#define EXTI_TZENR3    MMIO32(EXTI_BASE + 0x054)
