...
/* Alternate function high register (GPIOx_BRR) */
#define GPIO_BRR(port)			MMIO32(port + 0x28)
#define GPIOA_BRR			GPIO_AFRH(GPIOA)
#define GPIOB_BRR			GPIO_AFRH(GPIOB)
#define GPIOC_BRR			GPIO_AFRH(GPIOC)
#define GPIOD_BRR			GPIO_AFRH(GPIOD)
#define GPIOE_BRR			GPIO_AFRH(GPIOE)
#define GPIOF_BRR			GPIO_AFRH(GPIOF)
...
#define GPIO_OSPEED_10MHZ		0x1
//#define GPIO_OSPEED_2MHZ		0x2
#define GPIO_OSPEED_50MHZ		0x3
...
/*
 * Note: The F3 series has a completely new GPIO peripheral with different
