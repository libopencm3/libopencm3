...
/** @cond */
#ifdef LIBOPENCM3_CRS_H
/** @endcond */
#ifndef LIBOPENCM3_CRS_COMMON_AT32_H
#define LIBOPENCM3_CRS_COMMON_AT32_H
...
/** @cond */
#else
#warning "crs_common_at32.h should not be included explicitly, only via crs.h"
#endif
/** @endcond */
